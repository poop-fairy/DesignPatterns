"""
Challange:
Create a way to set and get configuration settings for an internet server
...
class SingletonConfigurationManager:
    ...
    def getInstance():
        if SingletonConfigurationManager.__instance is None:
            SingletonConfigurationManager()
        return SingletonConfigurationManager.__instance

    def __init__(self):
        if SingletonConfigurationManager.__instance is not None:
